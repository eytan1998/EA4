...
def egalitarian_allocation(valuations: list[list[float]], isBoolean=True, toPrint=True):
    #      r1  r2  r3  r4  r5
    #  p1 [11, 11, 22, 33, 44]
    #  p2 [11, 22, 44, 55, 66]
    #  p3 [11, 33, 22, 11, 66]
...
if __name__ == '__main__':
    ...
    #
    #     execution_time_boolean = timeit.timeit(lambda: egalitarian_allocation(valuations, True, False),
    #                                            number=times_to_run)
    #     execution_time = timeit.timeit(lambda: egalitarian_allocation(valuations, False, False), number=times_to_run)
    #
